 ...
 * \brief Dispatcher convenience class.
 *
 ...
 * Dispatcher class. You need to implement at least one method RunSolution()
 ...
 * synchronously, you can simply implement RunSolution() and call 
 ...
 * case, you implement RunSolution() to start some asynchronous process using
 ...
 * \fn bool Dispatcher::RunSolution()
 */
 ...
 * request from STDIN. Then it calls RunSolution and if needed will start a
 ...
 *
 * Get whether a main loop should be run after RunSolution is called. 
